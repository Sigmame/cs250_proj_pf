...
set max_del [expr "(${CLOCK_PERIOD} * 4) - (${PIPE_OVERHEAD}*4)"]
echo "Pre-retiming max_delay constraint value for combinational uvCalculation module : $max_del"
set_max_delay $max_del -to uvCalculation/result_reg*
# keep input/output and pipeline registers from moving
set_dont_retime iterCalc/uvCalculation/in_Ex*
set_dont_retime iterCalc/uvCalculation/in_Ey*
set_dont_retime iterCalc/uvCalculation/in_Et*
set_dont_retime iterCalc/uvCalculation/in_uAvg*
set_dont_retime iterCalc/uvCalculation/in_vAvg*
set_dont_retime iterCalc/uvCalculation/result_u*
set_dont_retime iterCalc/uvCalculation/result_v*
# do initial compile
...
set_optimize_registers true -design iterCalc/uvCalculation -clock ideal_clock1 -check_design -verbose -minimum_period_only -print_critical_loop
